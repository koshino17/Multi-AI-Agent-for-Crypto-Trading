...
class RuntimeRegressionTests(unittest.TestCase):
    ...
    def test_strategy_reflection_does_not_promote_negative_top_benchmark_to_watch_candidate(self) -> None:
        agent = StrategyReflectionAgent(llm_client=None)
        daily_summary = {
            "blocked_reason_counts": {},
            "rejection_reason_counts": {},
        ...
        reflection_context = {
            ...
            "previous_controls": {
                ...
                "benchmark_watch_symbol": "SOL/USDT",
            },
            "current_window_accepted_orders": 0,
            "current_window_closed_episodes": 0,
            "strategy_research_recommendation": {
        ...
        reflection = agent.evaluate("2026-08-24-day", daily_summary, reflection_context=reflection_context)
