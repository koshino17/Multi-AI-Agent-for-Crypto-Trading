...
- `LLM_WAKE_MIN_SCORE=3`
- `LLM_WAKE_QUIET_VOLATILITY_PCT=0.12`
...
LLM_WAKE_VOLATILITY_PCT=0.25
LLM_WAKE_MOMENTUM_PCT=0.20
LLM_WAKE_VOLUME_RATIO=1.25
LLM_WAKE_BREAKOUT_PROXIMITY_PCT=0.12
LLM_WAKE_POSITION_MOVE_PCT=0.20
LLM_WAKE_DEPTH_IMBALANCE=0.22
LLM_WAKE_TRADE_DELTA_RATIO=0.25
LLM_WAKE_LARGE_TRADE_COUNT=3
LLM_WAKE_QUIET_VOLATILITY_PCT=0.12
LLM_WAKE_QUIET_VOLUME_RATIO=0.95
