...
class Settings:
    ...
    llm_wake_depth_imbalance: float = _float("LLM_WAKE_DEPTH_IMBALANCE", 0.18)
    llm_wake_trade_delta_ratio: float = _float("LLM_WAKE_TRADE_DELTA_RATIO", 0.18)
    llm_wake_large_trade_count: int = _int("LLM_WAKE_LARGE_TRADE_COUNT", 2)
