        ...
        candidates.append(
            {
                ...
                "llm_wake": llm_wake,
                "market_structure": {
                    "po3_phase_hint": str(getattr(snapshot, "po3_phase_hint", "unknown") or "unknown"),
                    "poc_price": round(float(getattr(snapshot, "poc_price", 0.0) or 0.0), 6),
                    "poc_distance_bps": round(float(getattr(snapshot, "poc_distance_bps", 0.0) or 0.0), 4),
                    "value_area_high_price": round(float(getattr(snapshot, "value_area_high_price", 0.0) or 0.0), 6),
                    "value_area_low_price": round(float(getattr(snapshot, "value_area_low_price", 0.0) or 0.0), 6),
                    "value_area_high_distance_bps": round(float(getattr(snapshot, "value_area_high_distance_bps", 0.0) or 0.0), 4),
                    "value_area_low_distance_bps": round(float(getattr(snapshot, "value_area_low_distance_bps", 0.0) or 0.0), 4),
                    "nearest_bullish_fvg_distance_bps": round(float(getattr(snapshot, "nearest_bullish_fvg_distance_bps", 0.0) or 0.0), 4),
                    "nearest_bearish_fvg_distance_bps": round(float(getattr(snapshot, "nearest_bearish_fvg_distance_bps", 0.0) or 0.0), 4),
                    "fvg_fill_ratio": round(float(getattr(snapshot, "fvg_fill_ratio", 0.0) or 0.0), 4),
                },
